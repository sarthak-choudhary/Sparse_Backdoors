...
def _register_custom_op():
    ...
    # _cast_Long was removed in newer PyTorch versions
    # Create a compatibility function that uses Cast op directly
    def _cast_Long(g, input, non_blocking=False):
        """Cast input to Long (INT64) type for ONNX export.
        
        This is a compatibility function for newer PyTorch versions where
        _cast_Long was removed from symbolic_opset9.
        """
        # ONNX type code 7 corresponds to INT64 (Long)
